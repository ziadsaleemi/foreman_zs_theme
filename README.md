...
```bash
dnf install -y pkg/rpmbuild/RPMS/noarch/rubygem-foreman_zs_theme-0.1.135-1.el9.noarch.rpm
```
...
```bash
git tag -a v0.1.135 -m "foreman_zs_theme 0.1.135"
git push origin v0.1.135
```
